...
public interface GradeService {
    ...
    GradeDto getMyFilterGrade(Integer year, Semester semester, LoginUserDto loginUser);

    // (학년/학기)로 학생 성적 조회 [학부모/선생님 권한]
    GradeDto getFilterGrade(Long studentId, Integer year, Semester semester, LoginUserDto loginUser);

    // (학년/반/번호/학기)로 학생들 성적 조회 [선생님 권한]
    List<GradeDto> getStudentsGrade(Integer year, Integer classId, Integer number, Semester semester, LoginUserDto loginUser);
