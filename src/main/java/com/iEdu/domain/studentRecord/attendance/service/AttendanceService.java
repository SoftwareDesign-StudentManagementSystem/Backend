...
public interface AttendanceService {
    ...
    Page<AttendanceDto>  getMyFilterAttendance(Integer year, Semester semester, Integer month, Pageable pageable, LoginUserDto loginUser);

    // (학년/학기/월)로 학생 출결 조회 [학부모/선생님 권한]
    Page<AttendanceDto>  getFilterAttendance(Long studentId, Integer year, Semester semester, Integer month, Pageable pageable, LoginUserDto loginUser);
