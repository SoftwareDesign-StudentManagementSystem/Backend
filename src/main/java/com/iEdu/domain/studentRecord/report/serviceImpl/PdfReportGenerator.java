    ...
    private void addCounselSection(Document doc, List<Member> students, Integer year, Semester semester,
        ...
        for (Member student : students) {
            ...
            for (Counsel counsel : list) {
                ...
                table.addCell(new Paragraph(dto.getTeacherName()).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(dto.getContent()).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(dto.getNextCounselDate() != null ? dto.getNextCounselDate().toString() : "")
    ...
    private void addGradeSection(Document doc, List<Member> students, Integer year, Semester semester,
        ...
        for (Member student : students) {
            ...
            if (grade != null) {
                ...
                table.addCell(new Paragraph(String.valueOf(student.getNumber())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(semester.toKoreanString()).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get국어().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get수학().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get영어().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get사회().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get한국사().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get윤리().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get경제().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get물리().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get화학().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get생명과학().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get지구과학().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get음악().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get미술().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get체육().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get기술가정().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get컴퓨터().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.get제2외국어().getScore())).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(String.valueOf(dto.getGradeRank())).setFont(fontRegular).setFontSize(7));
            } else {
                // 데이터 없는 경우 빈칸 처리
                table.addCell(new Paragraph(student.getName()).setFont(fontRegular).setFontSize(7));
                table.addCell(new Paragraph(year.toString()).setFont(fontRegular).setFontSize(7));
                ...
                table.addCell(new Paragraph(semester.toKoreanString()).setFont(fontRegular).setFontSize(7));
                for (int i = 0; i < 18; i++) {
                    table.addCell(new Paragraph("-").setFont(fontRegular).setFontSize(7));
                }
            }
        }
        doc.add(table);
