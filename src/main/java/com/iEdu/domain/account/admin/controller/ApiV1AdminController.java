...
public class ApiV1AdminController {
    ...
    @PostMapping
    public ApiResponse<Void> adminSignup(@RequestBody @Valid MemberForm memberForm, @LoginUser LoginUserDto loginUser) {
    ...
    @GetMapping
    public ApiResponse<List<DetailMemberDto>> getMemberByRole(@ModelAttribute MemberPage request, @RequestParam(value = "role") String role,
